...
namespace RhythmVisualizatorPro {
    ...
    public class RhythmVisualizatorPro : MonoBehaviour
    {
        ...
        [Range(32, 512)]
        public int soundBarsQuantity = 100; // INCREASING THIS VALUE WILL IMPACT THE PERFORMANCE
...
#pragma warning restore 618
        ...
        public void Restart()
        {
            ...
            if ((soundBarPrefabCenter != null) && (soundBarPrefabDownside != null)) {
                ...
                else if (soundBarsQuantity > 512) {
                    soundBarsQuantity = 512;
                }
        ...
        void CreateCubes()
        {
            ...
            for (int i = 0; i < usedSoundBars; i++) {
                ...
                if (clone.GetComponent<SoundBar>().cube != null)
        ...
        public void NextForm(bool next)
        {
            ...
            if (visualizationNumber == 1) {
                ...
                visualization = Visualizations.Square;
            }
                ...
                if (useGradient) {
                    if (!colorUpdated) {
                        ...
                        for (int i = 0; i < soundBars.Count; i++) {
                            ...
                            if (soundBars[i].GetComponent<SoundBar>().cube != null)
