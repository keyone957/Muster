...
{
    // Basic version of Music Player to manage an AudioSource
    public class MusicPlayerBasic : MonoBehaviour
    {
        ...
        public static MusicPlayerBasic instance;
        ...
        /// <summary>
        /// Plays the sended audioclip
        /// </summary>
        /// <param name="audioClip"></param>
        public void SendSong (AudioClip audioClip)
        {
            audioSource.clip = audioClip;
            totalTime.text = SecondsToMinutesAndSeconds(audioClip.length);
